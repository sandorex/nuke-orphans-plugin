...
declare module "obsidian" {
	...
	// TODO the obsidian module does not expose the canvas.d.ts file so i copied it
	// obsidian version 1.2.8
	// permalink https://github.com/obsidianmd/obsidian-api/blob/b89eb0085d87ae725cf0b2513c609d0db1136899/canvas.d.ts
